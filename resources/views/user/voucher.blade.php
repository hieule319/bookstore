        ...
        <div class="profile-nav col-md-3">
            <div class="panel">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="{{ route('promotion.showPromotion') }}"> <i class="fa fa-gift" aria-hidden="true"></i> Voucher</a></li>
                    ...
                    <div class="col-md-6">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="bio-desk">
                                    <h4 class="red">{{ $val->promotion_name }}</h4>
                                    <p>Mã : <strong>{{$val->promotion_code}}</strong></p>
                                    <p>Chiết khấu : {{$val->promotion_discount}} %</p>
                                    <p>Điều kiện : {{$val->condition}} đơn hàng</p>
                                </div>
                            </div>
                        </div>
                    </div>
